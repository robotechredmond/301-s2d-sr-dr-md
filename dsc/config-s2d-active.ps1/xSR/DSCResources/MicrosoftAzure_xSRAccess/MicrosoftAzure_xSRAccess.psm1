#
# xSRAccess: DSC resource to configure SR access to a cluster. 
#
...
function Set-TargetResource
{
    ...
    {
        ($oldToken, $context, $newToken) = ImpersonateAs -cred $DomainAdministratorCredential
        Grant-SRAccess -Cluster $RemoteClusterName
        Grant-SRAccess -ComputerName $RemoteClusterName -Cluster $ClusterName
    }
    finally
    {
        if ($context)
